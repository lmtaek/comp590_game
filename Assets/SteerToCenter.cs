...
public class SteerToCenter : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float directionUserRotated = (d(currentPosition+prevForwardVector, currentPosition, currentPosition+currentForwardVector)<0)?-1:1;
    ...
    float d(Vector3 testPoint, Vector3 sourcePoint, Vector3 destinationPoint) {
